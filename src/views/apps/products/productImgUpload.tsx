...
import DefaultUploadImg from "./defaultUploadImg";
...
const ProductImgUpload = ({
  ...
  // console.log(imgUrl);
  return (
    <div className="bg-backgroundPaper px-8 py-8 rounded-md mb-6 text-center">
      <p className="text-base mb-4">Upload Image</p>
