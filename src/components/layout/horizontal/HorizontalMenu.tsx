    ...
    >
      ...
      >
        ...
        <SubMenu label={dictionary['navigation'].pages} icon={<i className='tabler-file' />}>
          <MenuItem href={`/${locale}/dashboard/user-profile`} icon={<i className='tabler-user-circle' />}>
            {dictionary['navigation'].userProfile}
          </MenuItem>
          <MenuItem href={`/${locale}/dashboard/account-settings`} icon={<i className='tabler-settings' />}>
